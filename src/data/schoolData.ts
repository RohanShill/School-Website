...
export const schoolData = {
  school: {
    ...
    established: '1912',
    principal: 'Mrs. Elizabeth Kerketta',
    principalHindi: 'श्रीमती एलिजाबेथ केरकेट्टा',
  ...
  faculty: [
    {
      ...
      role: 'Principal / Headmistress',
      roleHindi: 'प्रधानाध्यापिका (Principal)',
      qualification: 'Graduate (B.A.), 2-Yr Teachers’ Training',
      qualificationHindi: 'स्नातक (B.A.), द्विवर्षीय शिक्षक प्रशिक्षण',
      subject: 'School Administration & Primary Pedagogy',
      subjectHindi: 'विद्यालय प्रशासनिक नेतृत्व एवं शिक्षण',
      experience: 'Headmistress',
      experienceHindi: 'प्रधानाध्यापिका',
      image: '/images/logo.png',
      bio: 'Guiding the institution with a focus on quality education, discipline, and holistic student growth under the PM SHRI vision.',
      bioHindi: 'पीएम श्री विजन के अनुरूप गुणवत्तापूर्ण शिक्षा, अनुशासन और छात्रों के सर्वांगीण विकास का नेतृत्व करती हैं।',
    },
    {
      name: 'Mr. Rohan Shill',
